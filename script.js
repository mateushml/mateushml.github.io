document.addEventListener('DOMContentLoaded', () => {
    ...
    const init = () => {
        ...
        // ... (Restante dos listeners não precisam de alteração)
